...
_VERIDIAN_SENDER_BLOCKS = [
    ...
    "would rather you buy what we actually sell: the 70 percent "
    "automatic-resolution figure is "
...
_KINETIQ_SENDER_BLOCKS = [
    ...
    "figure, since surprises here are what stretch timelines: the "
    "schedule assumes the installation area offers "
